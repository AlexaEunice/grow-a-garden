// Vercel-specific hack (bypasses blessed)
if (process.env.VERCEL) {
  console.log("Running on Vercel - disabling dashboard");
  module.exports = require('express')(); // Dummy export
  process.exit(0); // Kill the server process
}
